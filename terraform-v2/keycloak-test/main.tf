locals {
  ...
  siteminder_single_sign_on_service_url = "https://test.loginproxy.gov.bc.ca/auth/realms/idir/protocol/saml"
  sandbox_client_redirect_uri           = "https://sso-keycloak-5-b861c7-test.apps.silver.devops.gov.bc.ca/*"
