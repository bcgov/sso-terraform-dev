module "all-non-siteminder-id-ps-conf-july-2023-8779" {
  source                              = "github.com/bcgov/sso-terraform-modules?ref=dev/modules/standard-client"
  realm_id                            = var.standard_realm_id
  client_id                           = "all-non-siteminder-id-ps-conf-july-2023-8779"
  client_name                         = "All Non Siteminder IDPs Conf July 2023"
