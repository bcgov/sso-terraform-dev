...
module "idir" {
  ...
  standard_realm_name         = local.standard_realm_name
  saml_entity_id              = "https://dev.sandbox.loginproxy.gov.bc.ca/auth/realms/_idir1/"
...
module "bceidbasic" {
  ...
  standard_realm_name         = local.standard_realm_name
  saml_entity_id              = "https://dev.sandbox.loginproxy.gov.bc.ca/auth/realms/_bceidbasic1/"
  single_sign_on_service_url  = local.siteminder_single_sign_on_service_url
  signing_certificate         = var.siteminder_signing_certificate
  sub_to_username             = true
  sandbox_client_redirect_uri = local.sandbox_client_redirect_uri
...
module "bceidbusiness" {
  ...
  standard_realm_name         = local.standard_realm_name
  saml_entity_id              = "https://dev.sandbox.loginproxy.gov.bc.ca/auth/realms/_bceidbusiness1/"
  single_sign_on_service_url  = local.siteminder_single_sign_on_service_url
  signing_certificate         = var.siteminder_signing_certificate
  sub_to_username             = true
  sandbox_client_redirect_uri = local.sandbox_client_redirect_uri
...
module "bceidboth" {
  ...
  standard_realm_name         = local.standard_realm_name
  saml_entity_id              = "https://dev.sandbox.loginproxy.gov.bc.ca/auth/realms/_bceidbasicbusiness1/"
  single_sign_on_service_url  = local.siteminder_single_sign_on_service_url
  signing_certificate         = var.siteminder_signing_certificate
  sub_to_username             = true
  sandbox_client_redirect_uri = local.sandbox_client_redirect_uri
