module "keycloak_dev" {
  ...
  verifiablecredential_authorization_url = var.dev_verifiablecredential_authorization_url
  verifiablecredential_token_url         = var.dev_verifiablecredential_token_url
}
...
module "keycloak_test" {
  ...
  verifiablecredential_authorization_url = var.test_verifiablecredential_authorization_url
  verifiablecredential_token_url         = var.test_verifiablecredential_token_url
}
...
module "keycloak_prod" {
  ...
  verifiablecredential_authorization_url = var.prod_verifiablecredential_authorization_url
  verifiablecredential_token_url         = var.prod_verifiablecredential_token_url
}
