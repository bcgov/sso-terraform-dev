module "keycloak_dev" {
  ...
  verifiablecredential_auhorization_url  = var.dev_verifiablecredential_authorization_url
...
module "keycloak_test" {
  ...
  verifiablecredential_auhorization_url  = var.test_verifiablecredential_authorization_url
...
module "keycloak_prod" {
  ...
  verifiablecredential_auhorization_url  = var.prod_verifiablecredential_authorization_url
